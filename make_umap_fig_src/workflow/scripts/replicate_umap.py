...
with Recorder(
    ...
    mapper.generate_rgb(sparsity_mult=20, umap_neighbors=n_neighbors, umap_min_dist=min_dist)
    recorder.register(n_neighbors)
    recorder.register(min_dist)
