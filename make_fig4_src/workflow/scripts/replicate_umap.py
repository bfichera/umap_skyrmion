...
with Recorder(
    ...
    recorder.register(img_stk.size, name='img_stk_size')
    if quick_test:
    ...
    recorder.register(low_res_feature_map.size, name='low_res_feature_map_size')
    ...
    recorder.register(window_ttcf.size, name='window_ttcf_size')
