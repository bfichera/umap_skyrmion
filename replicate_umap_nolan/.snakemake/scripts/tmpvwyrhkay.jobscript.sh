...
declare -A snakemake_input=( [0]="scripts/run.py" )
declare -A snakemake_output=( [0]="plots/output.pdf" )
declare -A snakemake_params=( )
declare -A snakemake_wildcards=( )
declare -A snakemake_resources=( [0]="1" [_cores]="1" [1]="1" [_nodes]="1" [2]="1000" [mem_mb]="1000" [3]="954" [mem_mib]="954" [4]="1000" [disk_mb]="1000" [5]="954" [disk_mib]="954" [6]="/tmp/3642938.sched5.carboncluster" [tmpdir]="/tmp/3642938.sched5.carboncluster" )
