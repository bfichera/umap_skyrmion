...
declare -A snakemake_resources=( [0]="1" [_cores]="1" [1]="1" [_nodes]="1" [2]="1000" [mem_mb]="1000" [3]="954" [mem_mib]="954" [4]="1000" [disk_mb]="1000" [5]="954" [disk_mib]="954" [6]="/tmp/3642051.sched5.carboncluster" [tmpdir]="/tmp/3642051.sched5.carboncluster" )
